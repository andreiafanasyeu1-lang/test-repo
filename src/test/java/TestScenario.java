...
public class TestScenario {
    public static void main(String[] args) {
        try (Playwright playwright = Playwright.create()) {
            ...
            page.fill("input[placeholder='DD.MM.YYYY']", "01.10.2025");

            // Step 9: Enter the '31.10.2025' value into the 'End date' field
            page.fill("input[placeholder='DD.MM.YYYY']", "31.10.2025");
            ...
            page.click("input[placeholder='0.00']");

            // Step 16: Enter the '1000' value
            page.fill("input[placeholder='0.00']", "1000");

            // Step 17: Click on the 'Description' input field
            page.click("text=To speed up the review by the SBC Team, describe the expense or work in detail here");

            // Step 18: Enter the '1000' value
            page.fill("text=To speed up the review by the SBC Team, describe the expense or work in detail here", "1000");
